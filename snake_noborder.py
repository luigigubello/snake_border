...
while (k != ord('q') and k != ord('Q')):
	...
	while (k == curses.KEY_DOWN):
		...
		while (i < (len(snake)-1)):
			...
			i += 1		
		if (snake[len(snake)-1][0] != height-2):
			snake[len(snake)-1][0] = snake[len(snake)-1][0] + 1
		elif (snake[len(snake)-1][0] == height-2):
	...
	while (k == curses.KEY_UP):
		...
		if (snake[len(snake)-1][0] != 1):		
			snake[len(snake)-1][0] = snake[len(snake)-1][0] - 1
		elif (snake[len(snake)-1][0] == 1):
			snake[len(snake)-1][0] = height-2
		i = 0
		while (i < (len(snake)-1)):
			if (snake[len(snake)-1][0] == snake[i][0] and snake[len(snake)-1][1] == snake[i][1]):
				j = 1
	...
	while (k == curses.KEY_RIGHT):
		...
		while (i < (len(snake)-1)):
			...
			snake[i][1] = snake[i+1][1]
			i += 1
		if (snake[len(snake)-1][1] != width-2):	
			snake[len(snake)-1][1] = snake[len(snake)-1][1] + 1
		elif (snake[len(snake)-1][1] == width-2):
	...
	while (k == curses.KEY_LEFT):
		...
		if (snake[len(snake)-1][1] != 1):
			snake[len(snake)-1][1] = snake[len(snake)-1][1] - 1
		elif (snake[len(snake)-1][1] == 1):
			snake[len(snake)-1][1] = width-2
		i = 0
		while (i < (len(snake)-1)):
			if (snake[len(snake)-1][0] == snake[i][0] and snake[len(snake)-1][1] == snake[i][1]):
				j = 1
